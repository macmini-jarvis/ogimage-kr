    ...
    <main className="max-w-2xl mx-auto px-6 py-16 text-white/80 text-sm leading-relaxed">
      ...
      <section className="space-y-6">
        <div>
          ...
          <p>본 약관은 soulmateai(이하 &quot;회사&quot;)가 운영하는 OGMaker(이하 &quot;서비스&quot;)가 제공하는 OG 이미지 생성 서비스의 이용 조건 및 절차, 이용자와 회사 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
        </div>

        <div>
          <h2 className="text-base font-semibold text-white mb-2">제2조 (서비스 제공자)</h2>
          <p>본 서비스는 soulmateai가 운영하며, 서비스 관련 문의는 아래 연락처로 가능합니다.</p>
        ...
        <div>
          ...
          <p>Pro 구독은 월간 또는 연간 단위로 제공되며, 결제는 Paddle을 통해 처리됩니다. 구독은 해지하지 않는 한 자동으로 갱신됩니다. 요금 및 구독 내용은 <Link href="/pricing" className="text-emerald-400 underline">가격 페이지</Link>에서 확인할 수 있습니다.</p>
        </div>

        <div>
          <h2 className="text-base font-semibold text-white mb-2">제6조 (환불)</h2>
          <p>구매 후 14일 이내에 환불을 요청하시면 사유에 관계없이 전액 환불해드립니다. 자세한 내용은 <Link href="/refund" className="text-emerald-400 underline">환불정책</Link>을 참고하세요.</p>
        </div>

        <div>
          <h2 className="text-base font-semibold text-white mb-2">제7조 (서비스 변경 및 중단)</h2>
          <p>회사는 운영상, 기술상의 사유로 서비스 내용을 변경하거나 중단할 수 있으며, 이 경우 사전에 공지합니다.</p>
        </div>

        <div>
          <h2 className="text-base font-semibold text-white mb-2">제8조 (면책)</h2>
          <p>회사는 사용자가 생성한 이미지의 내용에 대해 책임을 지지 않습니다. 천재지변, 서버 장애 등 불가항력으로 인한 서비스 중단에 대해 책임을 지지 않습니다.</p>
        </div>
